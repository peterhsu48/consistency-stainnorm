...
def main():
    ...
    logging.info("-------------------- target model --------------------")
    logging.info(target_model.__repr__())
    logging.info("-------------------- ************ --------------------")
    ...
    end_time = time.time()
    logger.log(f"Total training time (s): {end_time - start_time}")
...
def create_argparser():
    defaults = dict(
        ...
        log_interval=10,
        save_interval=10000,
        resume_online_checkpoint=None,
        resume_target_checkpoint=None,
        resume_opt_checkpoint=None,
        use_fp16=False,
        ...
        log_path="./logs",
        split_file=None,
        camelyon_log_file="./logs/train.log",
        num_epochs=5,
        start_epoch=0,
        seed=1234,
        global_step=0,
